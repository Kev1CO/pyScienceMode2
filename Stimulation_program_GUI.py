...
class Worker(QObject):
    ...
    def __init__(self, motomed: dict = None):
        ...
        channel_1 = Ch(mode="Single", no_channel=1, amplitude=0, pulse_width=300, frequency=10, name="Triceps_r", device_type=Device.Rehastimp24)
        channel_2 = Ch(mode="Single", no_channel=2, amplitude=0, pulse_width=300, frequency=10, name="Biceps_r", device_type=Device.Rehastimp24)
        channel_3 = Ch(mode="Single", no_channel=3, amplitude=0, pulse_width=300, frequency=10, name="Delt_ant_r", device_type=Device.Rehastimp24)
        channel_4 = Ch(mode="Single", no_channel=4, amplitude=0, pulse_width=300, frequency=10, name="Delt_post_r", device_type=Device.Rehastimp24)
        channel_5 = Ch(mode="Single", no_channel=5, amplitude=0, pulse_width=300, frequency=10, name="Triceps_l", device_type=Device.Rehastimp24)
        channel_6 = Ch(mode="Single", no_channel=6, amplitude=0, pulse_width=300, frequency=10, name="Biceps_l", device_type=Device.Rehastimp24)
        channel_7 = Ch(mode="Single", no_channel=7, amplitude=0, pulse_width=300, frequency=10, name="Delt_ant_l", device_type=Device.Rehastimp24)
        channel_8 = Ch(mode="Single", no_channel=8, amplitude=0, pulse_width=300, frequency=10, name="Delt_post_l", device_type=Device.Rehastimp24)
    ...
    def start_stimulation_program(self):
        ...
        if self.start_state is False:
            ...
            if self.ui.With_motomed_checkBox.isChecked():
                ...
                # self.worker.task2 = nidaqmx.Task()
                # for device in nidaqmx.system.System.local().devices:
                #     device_name = device.name
                #     self.worker.task2.ai_channels.add_ai_voltage_chan(device_name + '/ai14')
                # # local_system = nidaqmx.system.System.local()
                # # device_name = local_system.devices.name
                # # self.worker.task2.ai_channels.add_ai_voltage_chan('/ai14')
                # self.worker.task2.start()
